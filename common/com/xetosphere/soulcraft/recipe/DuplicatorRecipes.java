...
public class DuplicatorRecipes {
	...
	private DuplicatorRecipes() {
		...
		// 1000
		addDupling(ModItems.soroniteIngot.itemID, 0, new ItemStack(ModItems.soroniteIngot, 2, 0));
		addDupling(ModItems.soroniteIngot.itemID, 1, new ItemStack(ModItems.soroniteIngot, 2, 1));
		addDupling(ModItems.soroniteIngot.itemID, 2, new ItemStack(ModItems.soroniteIngot, 2, 2));
	}
