...
public class Strings {
	...
	public static final String ORE_NAME = "soroniteOre";
	public static final String BLOCK_NAME = "soroniteBlock";
	...
	/* Item name constants */
	public static final String DUST_NAME = "soroniteDust";
	public static final String ARCANEGEM_NAME = "arcaneGem";
	public static final String SOUL_NAME = "soul";
	public static final String INGOT_NAME = "soroniteIngot";
