...
import com.xetosphere.soulcraft.achievement.ModAchievements;
import com.xetosphere.soulcraft.block.ModBlocks;
import com.xetosphere.soulcraft.configuration.ConfigurationHandler;
import com.xetosphere.soulcraft.core.handler.EntityLivingHandler;
...
import com.xetosphere.soulcraft.recipe.ModCraftingRecipes;
...
public class SoulCraft {
	...
	public void preInit(FMLPreInitializationEvent e) {
		...
		// Adds the configuration, that can change block and item ids as well as making the mob spawn in an already existing world.
		...
		// Adds the moderations achievements and achievement page.
	...
	public void init(FMLInitializationEvent e) {
		...
		// Initialize custom rendering textures (Client only).
