...
public class TileDuplicator extends TileSC implements IInventory {
	...
	public void readFromNBT(NBTTagCompound nbtTagCompound) {
		...
		for (int i = 0; i < tagList.tagCount(); ++i) {
			...
			this.duplicatorDupleTime = nbtTagCompound.getShort("DuplicationTime");
	...
	public void writeToNBT(NBTTagCompound nbtTagCompound) {
		...
		nbtTagCompound.setShort("DuplicationTime", (short) this.duplicatorDupleTime);
	...
	public static int getTimeRequired(ItemStack stack) {
		...
		if (stack != null) {
			...
			else if (stack.itemID == Item.diamond.itemID || stack.itemID == Item.emerald.itemID || (stack.itemID == Item.appleGold.itemID && stack.getItemDamage() == 1)) {
				return 800;
			}
