...
public class OreGeneration implements IWorldGenerator {
	...
	private void genereateSurface(World world, Random random, int x, int z) {
		...
		addOre(ModBlocks.soroniteOre, Block.stone, world, random, x, z, 16, 16, 6 + random.nextInt(3), 14, 0, 90);
	}
	...
	public void addOre(Block block, Block blockBeingReplaced, World world, Random random, int blockXPos, int blockZPos, int maxX, int maxZ, int maxVeinSize, int chanceToSpawn, int minY, int maxY) {
